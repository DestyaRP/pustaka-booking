...
<head>     
	...
	<link rel="stylesheet" href="<?= base_url('assets/'); ?>user/css/bootstrap.cs s">     
			 ...
			 <div class="collapse navbar-collapse" id="navbarNavAltMarkup">                 
			 	<div class="navbar-nav">                     
			 		...
			 		if (!empty($this->session->userdata('email'))) { ?>                         
			 			<a class="nav-item navlink" href="<?= base_url('booking'); ?>">Booking <b><?= $this->ModelBooking>getDataWhere('temp', ['email_user' => $this->session->userdata('email')])>num_rows(); ?></b> 
			 			Buku</a>
